<div class="w-screen fixed left-0 right-0 top-0 m-0 bg-background-default p-3 px-8 h-32 lg:h-20">
    <div class=" w-full h-full flex">
        ...
        <nav class="invisible lg:visible grow pl-20 w-max space-x-4 text-xl h-full align-bottom leading-[4rem]">
