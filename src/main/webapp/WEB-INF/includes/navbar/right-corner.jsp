...
<div class="w-56 text-xl h-full align-bottom">
    ...
    <span id="navbar-toggle"
          class="inline w-fit h-full text-java-blue font-mono text-7xl cursor-pointer select-none float-right">
    ...
    <div id="navbar-content"
        ...
        <div class="w-full px-48 lg:p-0 lg:px-4 z-50">
            ...
            <c:choose>
                <c:when test="${empty user}">
                    ...
                    <a class="text-5xl lg:text-xl block underline decoration-wavy decoration-java-blue underline-offset-8 rounded-lg px-0 lg:px-6 py-3 align-top"
                       href="/login">Login</a>
                </c:when>
                <c:otherwise>
