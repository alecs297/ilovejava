...
<div class="grow w-screen px-16 grid">
    <form class="w-full text-4xl lg:text-base lg:w-1/2 lg:max-w-screen-sm place-self-center space-y-8 lg:space-y-3"
        ...
        <div class="my-16">
            ...
            <h2 class="text-4xl lg:text-2xl tracking-tight">Already have an account ? <a
                    class="underline text-java-pink"
                    href="${pageContext.request.contextPath}/login">Login</a></h2>
        </div>
