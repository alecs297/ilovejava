...
<div class="grow w-screen my-48 lg:my-28">
    <div class="w-full mx-8 lg:mx-auto lg:w-2/3">
        <h1 class="text-8xl lg:text-5xl mt-4 lg:mb-8 font-bold break-keep block"><span
                class="underline underline-offset-4 decoration-4 decoration-java-pink/80">${viewUser.username}</span> -
            <span class="text-java-pink">${viewUser.points}</span> points</h1>
        ...
        <div class="flex justify-start space-x-16 mb-8 lg:mb-0 lg:space-x-4">
            ...
            <a href="/users/${viewUser.username}/posts"><h2
                    class="text-6xl lg:text-2xl mt-4 lg:mb-8 font-bold underline underline-offset-4 decoration-4 decoration-java-blue/80">
                Posts</h2></a>
        </div>
