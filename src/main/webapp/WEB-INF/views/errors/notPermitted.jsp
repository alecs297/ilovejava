...
<div class="grow w-screen text-center">
    ...
    <h1 class="my-16 lg:my-8 text-5xl lg:text-xl font-bold"><%= pageContext.getAttribute("error") == null || pageContext.getAttribute("error").toString().isEmpty() ? "Sorry, you don't have the permission to do that" : pageContext.getAttribute("error").toString() %>
    </h1>
