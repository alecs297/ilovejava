...
<div class="grow w-screen px-16 break-words grid">
    <div class="max-w-full place-self-center font-bold text-7xl lg:text-5xl">
        ...
        <div class="lg:max-w-[66%] my-16 text-5xl lg:text-3xl tracking-tight break-words">
            ...
            <a class="underline underline-offset-8 decoration-8 decoration-java-blue/80 break-keep block lg:inline-block"
               href="/explore">explore existing discussions</a>
            or
            <a class="underline underline-offset-8 decoration-8 decoration-java-pink/80 break-keep block lg:inline-block"
               href="/new">start your own</a>
        </div>
    </div>
</div>
